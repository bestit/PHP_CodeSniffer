...
class AlphabeticallySortedUsesSniff extends AbstractSniff
{
     ...
     */
    private function compareUseStatementsByContent(UseStatement $prevStatement, UseStatement $nextStatement)
    {
     ...
     * @return int|null 1 <=> -1 To move statements in a direction.
     */
    private function compareUseStatementsByType(UseStatement $prevStatement, UseStatement $nextStatement)
    {
        $comparedByType = null;
